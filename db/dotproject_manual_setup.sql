...
#
INSERT INTO `dotp_modules`
VALUES ("1", "Companies", "companies", "1.0.0", "", "core", "1", "Companies", "handshake.png", "1", "1", "",
        "companies", "company_id", "company_name");
INSERT INTO `dotp_modules`
VALUES ("2", "Projects", "projects", "1.0.0", "", "core", "1", "Projects", "applet3-48.png", "2", "1", "", "projects",
        "project_id", "project_name");
INSERT INTO `dotp_modules`
VALUES ("3", "Tasks", "tasks", "1.0.0", "", "core", "1", "Tasks", "applet-48.png", "3", "1", "", "tasks", "task_id",
        "task_name");
INSERT INTO `dotp_modules`
VALUES ("4", "Calendar", "calendar", "1.0.0", "", "core", "1", "Calendar", "myevo-appointments.png", "4", "1", "",
        "events", "event_id", "event_title");
INSERT INTO `dotp_modules`
VALUES ("5", "Files", "files", "1.0.0", "", "core", "1", "Files", "folder5.png", "5", "1", "", "files", "file_id",
        "file_name");
INSERT INTO `dotp_modules`
VALUES ("6", "Contacts", "contacts", "1.0.0", "", "core", "1", "Contacts", "monkeychat-48.png", "6", "1", "",
        "contacts", "contact_id", "contact_title");
INSERT INTO `dotp_modules`
VALUES ("7", "Forums", "forums", "1.0.0", "", "core", "1", "Forums", "support.png", "7", "1", "", "forums", "forum_id",
        "forum_name");
INSERT INTO `dotp_modules`
VALUES ("8", "Tickets", "ticketsmith", "1.0.0", "", "core", "1", "Tickets", "ticketsmith.gif", "8", "1", "", "", "",
        "");
INSERT INTO `dotp_modules`
VALUES ("9", "User Administration", "admin", "1.0.0", "", "core", "1", "User Admin", "helix-setup-users.png", "9", "1",
        "", "users", "user_id", "user_username");
INSERT INTO `dotp_modules`
VALUES ("10", "System Administration", "system", "1.0.0", "", "core", "1", "System Admin", "48_my_computer.png", "10",
        "1", "", "", "", "");
INSERT INTO `dotp_modules`
VALUES ("11", "Departments", "departments", "1.0.0", "", "core", "1", "Departments", "users.gif", "11", "0", "",
        "departments", "dept_id", "dept_name");
INSERT INTO `dotp_modules`
VALUES ("12", "Help", "help", "1.0.0", "", "core", "1", "Help", "dp.gif", "12", "0", "", "", "", "");
INSERT INTO `dotp_modules`
VALUES ("13", "Public", "public", "1.0.0", "", "core", "1", "Public", "users.gif", "13", "0", "", "", "", "");
...
INSERT INTO `dotp_syskeys`
VALUES (1, "SelectList", "Enter values for list", "0", "\n", "|");
INSERT INTO `dotp_syskeys`
VALUES (2, 'CustomField',
        'Serialized array in the following format:\r\n<KEY>|<SERIALIZED ARRAY>\r\n\r\nSerialized Array:\r\n[type] => text | checkbox | select | textarea | label\r\n[name] => <Field\'s name>\r\n[options] => <html capture options>\r\n[selects] => <options for select and checkbox>',
        0, '\n', '|');
INSERT INTO `dotp_syskeys`
VALUES (3, "ColorSelection", "Hex color values for type=>color association.", "0", "\n", "|");

INSERT INTO `dotp_sysvals` (`sysval_key_id`, `sysval_title`, `sysval_value`)
VALUES (1, "ProjectStatus",
        "0|Not Defined\r\n1|Proposed\r\n2|In Planning\r\n3|In Progress\r\n4|On Hold\r\n5|Complete\r\n6|Template\r\n7|Archived");
INSERT INTO `dotp_sysvals` (`sysval_key_id`, `sysval_title`, `sysval_value`)
...
INSERT INTO `dotp_sysvals` (`sysval_id`, `sysval_key_id`, `sysval_title`, `sysval_value`)
...
INSERT INTO `dotp_config`
VALUES (0, 'host_locale', 'en', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'check_overallocation', 'false', 'tasks', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'currency_symbol', '$', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'host_style', 'default', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'company_name', 'My Company', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'page_title', 'dotProject', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'site_domain', 'example.com', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'email_prefix', '[dotProject]', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'admin_username', 'admin', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'username_min_len', '4', 'auth', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'password_min_len', '4', 'auth', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'enable_gantt_charts', 'true', 'tasks', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'log_changes', 'false', '', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'check_task_dates', 'true', 'tasks', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'check_task_empty_dynamic', 'false', 'tasks', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'locale_warn', 'false', 'ui', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'locale_alert', '^', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'daily_working_hours', '8.0', 'tasks', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'display_debug', 'false', 'ui', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'link_tickets_kludge', 'false', 'tasks', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'show_all_task_assignees', 'false', 'tasks', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'direct_edit_assignment', 'false', 'tasks', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'restrict_color_selection', 'false', 'ui', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'cal_day_view_show_minical', 'true', 'calendar', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'cal_day_start', '8', 'calendar', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'cal_day_end', '17', 'calendar', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'cal_day_increment', '15', 'calendar', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'cal_working_days', '1,2,3,4,5', 'calendar', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'restrict_task_time_editing', 'false', 'tasks', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'default_view_m', 'calendar', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'default_view_a', 'day_view', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'default_view_tab', '1', 'ui', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'index_max_file_size', '-1', 'file', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'session_handling', 'app', 'session', 'select');
INSERT INTO `dotp_config`
VALUES (0, 'session_idle_time', '2d', 'session', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'session_max_lifetime', '1m', 'session', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'debug', '1', '', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'parser_default', '/usr/bin/strings', 'file', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'parser_application/msword', '/usr/bin/strings', 'file', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'parser_text/html', '/usr/bin/strings', 'file', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'parser_application/pdf', '/usr/bin/pdftotext', 'file', 'text');

# 20050222
# moved new config variables by cyberhorse from config-php to a new table
INSERT INTO `dotp_config`
VALUES (0, 'files_ci_preserve_attr', 'true', 'file', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'files_show_versions_edit', 'false', 'file', 'checkbox');

# 20050302
# ldap system config variables
INSERT INTO `dotp_config`
VALUES (0, 'auth_method', 'sql', 'auth', 'select');
INSERT INTO `dotp_config`
VALUES (0, 'ldap_host', 'localhost', 'ldap', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'ldap_port', '389', 'ldap', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'ldap_version', '3', 'ldap', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'ldap_base_dn', 'dc=saki,dc=com,dc=au', 'ldap', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'ldap_user_filter', '(uid=%USERNAME%)', 'ldap', 'text');

# 20050302
# PostNuke authentication variables
INSERT INTO `dotp_config`
VALUES (0, 'postnuke_allow_login', 'true', 'auth', 'checkbox');
...
INSERT INTO dotp_config_list (`config_id`, `config_list_name`)
...
INSERT INTO `dotp_config`
VALUES (0, 'reset_memory_limit', '32M', 'tasks', 'text');

# 20050303
# New mail handling options
INSERT INTO `dotp_config`
VALUES (0, 'mail_transport', 'php', 'mail', 'select');
INSERT INTO `dotp_config`
VALUES (0, 'mail_host', 'localhost', 'mail', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'mail_port', '25', 'mail', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'mail_auth', 'false', 'mail', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'mail_user', '', 'mail', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'mail_pass', '', 'mail', 'password');
INSERT INTO `dotp_config`
VALUES (0, 'mail_defer', 'false', 'mail', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'mail_timeout', '30', 'mail', 'text');
...
INSERT INTO dotp_config
VALUES (NULL, 'session_gc_scan_queue', 'false', 'session', 'checkbox');

# 20060321
# Backport of task reminders.
INSERT INTO `dotp_config`
VALUES (0, 'task_reminder_control', 'false', 'task_reminder', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'task_reminder_days_before', '1', 'task_reminder', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'task_reminder_repeat', '100', 'task_reminder', 'text');

# 20080702
# GACL Caching options
INSERT INTO dotp_config
VALUES (NULL, 'gacl_cache', 'false', 'gacl', 'checkbox'),
...
INSERT INTO `dotp_config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`)
...
INSERT INTO `dotp_gacl_phpgacl` (name, value)
VALUES ('version', '3.3.2');
INSERT INTO `dotp_gacl_phpgacl` (name, value)
VALUES ('schema_version', '2.1');

INSERT INTO `dotp_gacl_acl_sections` (id, value, order_value, name)
VALUES (1, 'system', 1, 'System');
INSERT INTO `dotp_gacl_acl_sections` (id, value, order_value, name)
...
INSERT INTO dotp_dpversion
VALUES ('2.1.8', 2, '2013-01-05', '2013-07-27');

# 20050307
# Additional LDAP search user and search password fields for Active Directory compatible LDAP authentication
INSERT INTO `dotp_config`
VALUES (0, 'ldap_search_user', 'Manager', 'ldap', 'text');
INSERT INTO `dotp_config`
VALUES (0, 'ldap_search_pass', 'secret', 'ldap', 'password');
INSERT INTO `dotp_config`
VALUES (0, 'ldap_allow_login', 'true', 'ldap', 'checkbox');
...
INSERT INTO `dotp_config`
VALUES (0, 'user_contact_inactivate', 'true', 'auth', 'checkbox');
INSERT INTO `dotp_config`
VALUES (0, 'user_contact_activate', 'false', 'auth', 'checkbox');

# 20130105
INSERT INTO `dotp_config`
VALUES (0, 'task_reminder_batch', 'false', 'task_reminder', 'checkbox');
