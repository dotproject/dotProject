...
{ width: c.offsetWidth, height: c.offsetHeight }
    ...
    8, 12]], [ga, [1]], [Ma, [1]], [Na, [1, 3, 6]], [ta, null]], Ia = {
        ...
        drawHandle: function (a, b) {
            ...
            this.rightShade = this.outline = this.scrollbarTrack = this.scrollbarRifles = this.scrollbarGroup = this.scrollbar = null; n([this.scrollbarButton                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Ì d[1], delete this.previousZoom); return h !== w ? h : a.call(this, b, c)
