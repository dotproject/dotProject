...
if (!empty($allowedProjects) && (is_array($allowedProjects) || $allowedProjects instanceof Countable)) {  // PHP 7.2+ handles count() differently; also see https://www.php.net/manual/en/function.count.php#123669 (gwyneth 20210416)
