...
function rclick(e){
	...
	if(ev==2||ev==3){
            ...
            if(contextObject.parentNode.id.indexOf("row_")!=-1 || contextObject.parentNode.parentNode.id.indexOf("row_")!=-1){
                if(contextObject.parentNode.title=="non_leaf" || contextObject.parentNode.parentNode.title=="non_leaf" ){
                    contextMenu = "contextMenuWBSNonWorkPackage";
                }else{
                   contextMenu="contextMenuWBS";
                }
            }else if(contextObject.parentNode.id.indexOf("activity_id_")!=-1 || contextObject.parentNode.parentNode.id.indexOf("activity_id_")!=-1){
                contextMenu="contextMenu";
            }else if(contextObject.id.indexOf("new_activity")!=-1 ){
                contextMenu="contextMenuWBSNewActivity";
            }
            if(contextMenu==null){
                return false;
            }
