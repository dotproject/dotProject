...
<div style="font-size: 14px;font-weight: bold;cursor:pointer;" onclick="showProjectForm()" >
    <?php echo $obj->project_name ?> &nbsp;<img src='./modules/dotproject_plus/images/icone_seta.png' />
</div>
<div style="float:right;text-align: right">
    <input type="button" onclick="window.location='index.php?m=projects&a=addedit&project_id=<?php echo $project_id ?>';" value="Editar" class="button" />
...
<table  border="0" cellpadding="4" cellspacing="0" width="100%" class="std" id="table_project_form">
    ...
    <tr> 
        ...
        <td><?php echo @$obj->project_target_budget; ?></td>
    </tr>
