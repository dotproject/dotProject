...
<?php foreach ($list as $row) { ?>
        <tr>
            <td>                
                <a href="index.php?m=scopeplanning&a=view_wbs&project_id=<?php echo $row['project_id'] ?>&project_name=<?php echo $row['project_name'] ?>"><?php echo $AppUI->_("LBL_SP_VIEW"); ?></a>
                <a>|</a>
                <a href="index.php?m=scopeplanning&a=addedit_wbs&project_id=<?php echo $row['project_id'] ?>&project_name=<?php echo $row['project_name'] ?>"><?php echo $AppUI->_("LBL_SP_ADDEDIT"); ?></a>               
            </td>
