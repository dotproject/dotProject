...
$titleBlock = new CTitleBlock('LBL_SP_WBS', 'scope.png', $m, "$m.$a");
    ...
    <tr>
        <td align="center" colspan="2">
            <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tbl">
                <tr>
                    <th align="left" nowrap="nowrap"><?php echo $AppUI->_('LBL_SP_WBS_ID'); ?></th>
                    <th align="left" nowrap="nowrap"><?php echo $AppUI->_('LBL_SP_WBS_ITEM'); ?></th>        
                </tr>
