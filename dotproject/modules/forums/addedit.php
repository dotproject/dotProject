...
if ($canDelete) {
	$titleBlock->addCrumbRight(
		'<a href="javascript:delIt()"><img align="middle" src="' . dPfindImage('stock_delete-16.png', $m) . '" width="16" height="16" alt="" border="0" />&nbsp;' . $AppUI->_('delete forum')
			. '</a>'
	);
}
$titleBlock->show();
...
<tr>
	...
	<td valign="top" width="50%">
		...
		<textarea class="textarea" name="forum_description" style="height:150px;" rows="10" cols="40"><?php echo @$forum_info["forum_description"];?></textarea>
	</td>
</tr>
